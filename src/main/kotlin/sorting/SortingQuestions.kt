...
class SortingQuestions {
	...
	//#2 - eBay sorts listings by the current Bid amount: Merge / Could be Radix-Counting

	//#3 - Sport scores on ESPN: Quick

	//#4 - Massive database (can't fit all into memory) needs to sort through past year's user data: Merge (not in memory)

	//#5 - Almost sorted Udemy review data needs to update and add 2 new reviews: Insertion

	//#6 - Temperature Records for the past 50 years in Canada: Quick
